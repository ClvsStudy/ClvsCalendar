...
public class AppConfig {
    ...
    public static final class EnvVariableName {
        ...
        static String slackBotToken = env.getProperty("SLACK_BOT_TOKEN");
        static String slackSigningSecret = env.getProperty("SLACK_SIGNING_SECRET");

        public static final String SLACK_BOT_TOKEN = slackBotToken;
        public static final String SLACK_SIGNING_SECRET =slackSigningSecret;
